<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Main.aspx.vb" Inherits="Project.Main" %>
...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
                <asp:ImageButton ID="UpdateButton" runat="server" Height="142px" ImageUrl="~/pics/6.png" Width="205px" />
            &nbsp;&nbsp;<br />
&nbsp;<asp:ImageButton ID="ImageButton2" runat="server" Height="142px" ImageUrl="~/pics/7.png" Width="205px" />
            &nbsp;
