...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
                <asp:ImageButton ID="ImageButton1" runat="server" Height="142px" ImageUrl="~/pics/1.png" Width="205px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="ImageButton2" runat="server" Height="142px" ImageUrl="~/pics/2.png" Width="205px" />
            </div>
    </form>
    <p class="auto-style4">
